...
import { Formulario, GlobalLabel, Texto, FormCheckbox, TextoCheckbox, PdfStyles, CanvasContainer, Canvas, ButtonCanvas, CanvasAssinaturaTexto, InputCheckbox, CanvasButtons, CanvasButtonContainer, ButtonReload } from "../../styles/styles";
