import { Subtitulo, Texto } from "../../../styles/styles"

function TextoBeneficios() {
    return (
        <>
            <Subtitulo>Auxílio doença</Subtitulo>
            <Texto>
                O beneficiário que recebe esse auxílio doença é considerado incapacitado para trabalhar, e se ele abrir um registro como mei, ele provará que pode voltar as suas atividades profissionais, portanto perderá o benefício previdenciário.
            </Texto>
            <Subtitulo>Tutor que recebe pensão por um menor de idade</Subtitulo>
            <Texto>
            ...
            <Subtitulo>Bolsa família</Subtitulo>
            <Texto>
            ...
            <Subtitulo>Seguro desemprego</Subtitulo>
            <Texto>
...
} export default TextoBeneficios