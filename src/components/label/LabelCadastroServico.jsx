...
import { Formulario, Texto, FormCheckbox, TextoCheckbox, PdfStyles, CanvasContainer, Canvas, ButtonCanvas, CanvasAssinaturaTexto, InputCheckbox, CanvasButtons, CanvasButtonContainer, ButtonReload } from "../../styles/styles";
import SecaoCadastroServico from "../sections/SectionCadServ";
    ...
    return (
        <>
            ...
            <FormCheckbox>
                ...
                <TextoCheckbox>Declaro ter recebido as devidas orientações quanto ao sistema de emissão de notas do simples nacional.</TextoCheckbox>
            </FormCheckbox>
