...
import { ButtonReload, CanvasButtonContainer, CanvasButtons, PdfStyles } from "../../styles/styles";
            ...
            <Document>
              <Page size='A4' style={PdfStyles.page}>
                <View style={PdfStyles.section}>
                  ...
                  <Text style={{ marginTop: 10 }}>Telefone</Text>
                  <Text></Text>
                  <Text style={{ marginTop: 5, marginLeft: 10 }}>{document.getElementById('telefone2').value}</Text>
                  ...
                  <Text style={{ marginTop: 10 }}>Telefone</Text>
                  <Text></Text>
                  <Text style={{ marginTop: 5, marginLeft: 10 }}>{document.getElementById('telefone3').value}</Text>
                  <Text style={{ marginTop: 10 }}>Endereço</Text>
                  <Text></Text>
...
} export default PdfFormCadastro