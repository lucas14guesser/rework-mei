...
const AssPdfCancelamentoDebito = () => {
                    ...
                    <Document>
                        <Page size='A4' style={PdfStyles.page}>
                            <View style={PdfStyles.section}>
                                ...
                                <Text></Text>
                                <Text style={{ marginTop: 5, marginLeft: 10 }}>{document.getElementById('cancelamento').value}</Text>
...
export default AssPdfCancelamentoDebito